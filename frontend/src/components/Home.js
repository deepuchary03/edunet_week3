...
function Home() {
  ...
  const [token, setToken] = useState(
    "BQDwu7m470dh1_8U5xJJk8p2lDQHcjPZOboilLBZeYwMS2EKNFvdaynrdaCK9YBSdPAIYLuMMta50jhv1oCDNznlo1VQ4fsvGJ3CvZzPy7toU5QkqdDxwQNxSbXXhEbpjCUTqSn2UEvCwkIX4T2t_trQjTSbSf5bG8c9irqdYgfXtjHZOpczNkEQHJxGUFjP2a3y2qqyxG5WRUKP6ASZiFw4iDhfOou3KwIFxH0v"
  ...
  // Use useEffect to call refreshToken every 60 minutes
  useEffect(() => {
    const intervalId = setInterval(refreshToken, 60 * 60 * 1000); // every 60 minutes
